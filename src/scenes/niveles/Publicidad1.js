export class Publicidad1 {
    ...
    create() {
        ...
        this.relatedScene.video1 = this.relatedScene.add.video(this.relatedScene.cameras.main.width / 2, window.innerHeight * 0.5, 'videoPublicidad1').setScale(window.innerWidth * 0.0014, window.innerHeight * 0.0008).setDepth(2);

...
export class Nivel5 extends Phase {
    create() {
        ...
        this.relatedScene.respuesta1.setColor('#FFFFFF').setShadow(1, 1, '#000000', 1).setStroke(null, 0);
        this.relatedScene.respuesta2.setColor('#FFFFFF').setShadow(1, 1, '#000000', 1).setStroke(null, 0);
        this.relatedScene.respuesta3.setColor('#FFFFFF').setShadow(1, 1, '#000000', 1).setStroke(null, 0);
        ...
        this.relatedScene.opcionA1 = this.relatedScene.physics.add.image(60, 910, 'opcionA1').setDepth(1);
        ...
        this.relatedScene.opcionB1 = this.relatedScene.physics.add.image(230, 910, 'opcionB1').setDepth(1);
        ...
        this.relatedScene.opcionC1 = this.relatedScene.physics.add.image(390, 910, 'opcionC1').setDepth(1);

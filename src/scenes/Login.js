...
class Login extends Phaser.Scene {
    ...
    preload(){
        ...
        // this.load.image('text_inicio', 'assets/inicia_sesion.png');
        this.load.image('iniciarSesion', 'assets/inicia_sesion.png');
        this.load.image('btnOmitir1', 'assets/btnAtras1.png');
        ...
        this.load.image('btnEntrar', 'assets/btnEntradaInicio.png');
    }
    ...
    create(){
        ...
        this.iniciarSesion = this.add.image(this.cameras.main.width / 2, window.innerHeight * 0.38, 'iniciarSesion');
        ...
        let inputEmail = this.add.rexInputText(this.cameras.main.width * 0.46, window.innerHeight * 0.42, 300, 52, {
        ...
        let inputClave = this.add.rexInputText(this.cameras.main.width * 0.46, window.innerHeight * 0.5, 300, 52, {
            backgroundColor: '#FFFFFF',
            color: '#000000',
            fontFamily: 'Arial',
            fontSize: '24px',
        ...
        this.btnEntrar = this.add.sprite(this.cameras.main.width * 0.52, window.innerHeight * 0.65, 'btnEntrar').setDepth(1).setInteractive();
        ...
        this.btnRegistrarse = this.add.image(this.cameras.main.width * 0.68, window.innerHeight * 0.75, 'btnRegistrarse').setDepth(1).setInteractive();
        ...
        this.btnGoogle = this.add.image(this.cameras.main.width * 0.3, window.innerHeight * 0.75, 'google').setInteractive();
        ...
        this.btnOutlook = this.add.image(this.cameras.main.width * 0.45, window.innerHeight * 0.75, 'outlook').setInteractive();
        ...
        this.btnOmitir1 = this.add.image(this.cameras.main.width * 0.52, window.innerHeight * 0.85, 'btnOmitir1').setInteractive();
        this.btnOmitir1.setScale(window.innerWidth * 0.0018, window.innerHeight * 0.0012);
        this.btnOmitir1.texture.setFilter(Phaser.Textures.FilterMode.LINEAR);
        
        this.btnOmitir1.on('pointerdown', () => {
